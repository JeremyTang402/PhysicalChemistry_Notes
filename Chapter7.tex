...
代入推导式得
\begin{equation}
    S = k_\mathrm{B} N \ln{\sum_{i} \mathrm{e}^{\varepsilon_i / k_\mathrm{B} T}} + \frac{U}{T}
\end{equation}
由
\begin{equation*}
    A = U - T S
...
得
\begin{equation}
    A = -k_\mathrm{B} N T \ln{\sum_{i} \mathrm{e}^{\varepsilon_i / k_\mathrm{B} T}}
\end{equation}
...
\begin{enumerate}
    ...
    \end{equation}
    \begin{equation}
        S_{\text{定位}} = k_\mathrm{B} N \ln{\sum_{i} g_i \mathrm{e}^{\varepsilon_i / k_\mathrm{B} T}} + \frac{U}{T}
    \end{equation}
    \begin{equation}
        A_{\text{定位}} = -k_\mathrm{B} N T \ln{\sum_{i} g_i \mathrm{e}^{\varepsilon_i / k_\mathrm{B} T}}
    \end{equation}
    只是多了相应的 $g_i$ 项。
